            ...
            <form name="FindProductionRun" action="<@ofbizUrl>FindProductionRun</@ofbizUrl>" method="post">
                <table width="100%">
                    <tr>
                        ...
                        <td width="2%"></td>
                        <td width="83%"><input type="text" name="workEffortId" value="${parameters.workEffortId!}"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="2%"></td>
                        <td width="83%"><@htmlTemplate.lookupField value="${parameters.productId!}"
                            formName="CreateProductionRunFromByJava" name="productId" id="productId"
                    ...
                    <tr>
                        ...
                        <td width="2%"></td>
                        <td width="83%"><input type="text" name="workEffortName" value="${parameters.workEffortName!}"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" align="right"><span class="label">${uiLabelMap.StartDate}</span></td>
                        <td width="2%"></td>
                        <td width="83%"><@htmlTemplate.renderDateTimeField name="estimatedStartDate" event="" action=""
                            className="" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS"
                            value="${parameters.estimatedStartDate!}" size="" maxlength="50" id="fromDate_1"
                            dateType="date" shortDateInput=false timeDropdownParamName="" defaultDateTimeString=""
                    ...
                    <tr>
                        ...
                        <td width="83%">
                            <select name="facilityId">
                                ...
                                <option name="facilityId" value="${facility.facilityId!}"
                                <#if parameters.facilityId?has_content && parameters.facilityId ==
                                facility.facilityId>selected</#if>>${facility.facilityId!}</option>
                        </#list>
                        </select>
                        </td>
                    </tr>
